...
const Login = () => {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'Inter', sans-serif" }}>
            ...
            {/* Panneau gauche */}
            <div style={{ width: '48%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 48, background: 'linear-gradient(135deg, #016472 0%, #004e5a 100%)', position: 'relative', overflow: 'hidden' }}>
                <div style={{ position: 'absolute', top: -80, right: -80, width: 300, height: 300, background: '#E8613A', borderRadius: '50%', filter: 'blur(80px)', opacity: 0.15 }} />
                <Link to="/"><img src={logo} alt="Dokita" style={{ height: 44 }} /></Link>
                <div style={{ position: 'relative', zIndex: 1 }}>
                    <h2 style={{ fontSize: 36, fontWeight: 800, color: 'white', lineHeight: 1.25, marginBottom: 16, letterSpacing: '-0.02em' }}>Bon retour sur<br />Dokita 👋</h2>
                    <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: 15, marginBottom: 32, lineHeight: 1.6 }}>Accédez à vos consultations, dossiers médicaux et bien plus.</p>
            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f9f9ff', padding: 32 }}>
                <div style={{ width: '100%', maxWidth: 420 }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ marginBottom: 8, position: 'relative' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <input type={showPassword ? 'text' : 'password'} name="password" value={form.password} onChange={handleChange} placeholder="••••••••" required style={{ ...inputStyle, paddingRight: 44 }} />
                    ...
                    <p style={{ textAlign: 'center', fontSize: 14, color: '#3f484b' }}>
                        Pas encore de compte ?{' '}
                        <Link to="/register" style={{ color: '#016472', fontWeight: 700, textDecoration: 'none' }}>S'inscrire gratuitement</Link>
                    </p>
                </div>
            </div>
        </div>
...
const inputStyle = { width: '100%', border: '1.5px solid #dde3f0', borderRadius: 12, padding: '13px 16px', fontSize: 14, background: 'white', outline: 'none', boxSizing: 'border-box', fontFamily: 'inherit', transition: 'border-color 0.2s' };
