...
import {
  Home, Calendar, Users, Stethoscope, FileText, Video,
...
const NAV_ITEMS = [
  ...
  { path:'/patient/rdv',            icon: Calendar,      label:'Rendez-vous' },
  { path:'/patient/consultations',  icon: Video,         label:'Consultations' },
